...
class UpdatePLC(QtCore.QObject):
    ...
    def or_alarm_signal(self):
        ...
        if self.true_in_dictionary(self.PLC.TT_BO_Alarm) or self.true_in_dictionary(self.PLC.PT_Alarm) or self.true_in_dictionary(self.PLC.TT_FP_Alarm) or self.true_in_dictionary(self.PLC.LEFT_REAL_Alarm) or self.true_in_dictionary(self.PLC.Din_Alarm) or self.true_in_dictionary(self.PLC.LOOPPID_Alarm)or self.true_in_dictionary(self.PLC.AD_Alarm):
...
class Update(QtCore.QObject):
    ...
    def connect_signals(self):
        ...
        self.UpPLC.test_sig.connect(self.printstr)
