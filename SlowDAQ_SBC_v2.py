...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def signal_connection(self):
        ...
        BORTD_AlarmMatrix = [self.AlarmButton.SubWindow.TT2101, self.AlarmButton.SubWindow.TT2111,
        ...
        for i in range(BORTD_AlarmLen):
            ...
            BORTD_AlarmMatrix[i].AlarmMode.stateChanged.connect(
                lambda x=i: self.BOTTBoxUpdate(pid=BORTD_AlarmMatrix[x].Label.text(),
                                           Act=BORTD_AlarmMatrix[x].AlarmMode.isChecked(),
                                           LowLimit=BORTD_AlarmMatrix[x].Low_Limit.Field.text(),
                                           HighLimit=BORTD_AlarmMatrix[x].High_Limit.Field.text()))
...
class AlarmWin(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.AlarmRTDLEFTdir = {0: {0: self.TT4330, 1: self.TT6220, 2: self.TT6213, 3: self.TT6401, 4: self.TT6203},
                                ...
                                4: {0: self.TT6222, 1: self.TT6407, 2: self.TT6415, 3: self.TT6416}}
    ...
    def run(self):
        try:
            ...
            while self.Running:
                ...
                self.MW.TT6220.SetValue(self.Client.receive_dic["data"]["TT"]["FP"]["TT6220"])
                self.MW.TT6401.SetValue(self.Client.receive_dic["data"]["TT"]["FP"]["TT6401"])
                self.MW.TT6404.SetValue(self.Client.receive_dic["data"]["TT"]["FP"]["TT6404"])
                self.MW.TT6405.SetValue(self.Client.receive_dic["data"]["TT"]["FP"]["TT6405"])
                self.MW.TT6406.SetValue(self.Client.receive_dic["data"]["TT"]["FP"]["TT6406"])
                self.MW.TT6410.SetValue(self.Client.receive_dic["data"]["TT"]["FP"]["TT6410"])
                self.MW.TT6411.SetValue(self.Client.receive_dic["data"]["TT"]["FP"]["TT6411"])
                self.MW.TT6412.SetValue(self.Client.receive_dic["data"]["TT"]["FP"]["TT6412"])
                self.MW.TT6413.SetValue(self.Client.receive_dic["data"]["TT"]["FP"]["TT6413"])
