...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def updatedisplay(self, received_dic_c):
        ...
        self.PTAlarmMatrix = [self.AlarmButton.SubWindow.PT2316,self.AlarmButton.SubWindow.PT2321, self.AlarmButton.SubWindow.PT2330, self.AlarmButton.SubWindow.PT2335,
