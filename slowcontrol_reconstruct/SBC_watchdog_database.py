...
class mydatabase():
    def __init__(self):
        ...
        self.db = mysql.connector.connect( user="slowcontrol", passwd=os.environ.get("SLOWCONTROL_LOCAL_TOKEN"), database="SBCslowcontrol",unix_socket="/home/sbcdatabase/mysql/mysql.sock")
